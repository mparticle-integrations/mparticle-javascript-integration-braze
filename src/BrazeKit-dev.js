...
var constructor = function () {
    ...
    function initForwarder(
        ...
        console.warn(
            'mParticle is in the process of upgrading the Braze web kit and Braze SDK that you are currently using from V3 to V4.  This will be an opt-in update, but we recommend you opt in to get the latest bug fixes and features from Braze.  Please see https://docs.mparticle.com/integrations/braze/event for more information and necessary upgrade steps when you decide to opt in.'
        );
